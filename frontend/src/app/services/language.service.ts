    ...
    private translations: any = {
        'en': {
            ...
            'terms': {
                ...
                'acceptance_desc': 'By accessing or using Chatme, you agree to be bound by these Terms of Service and all applicable laws and regulations.',
                'eligibility_title': 'Eligibility',
                'eligibility_desc': 'You must be at least 13 years old to use Chatme. By using the service, you represent and warrant that you meet this age requirement.',
                'registration_title': 'User Registration',
                'registration_desc': 'You may be required to register for an account to access certain features. You are responsible for maintaining the confidentiality of your account information.',
                'user_conduct_title': 'User Conduct',
                'user_conduct_desc': 'You agree not to use the service for any unlawful purpose or to engage in any conduct that violates the rights of others, including harassment or sharing inappropriate content.',
                'content_ownership_title': 'Content Ownership',
                'content_ownership_desc': 'You retain ownership of the content you post on Chatme. However, by posting content, you grant us a non-exclusive, royalty-free license to use, display, and distribute it.',
                'termination_title': 'Termination',
                'termination_desc': 'We reserve the right to terminate or suspend your access to the service at our sole discretion, without notice, for conduct that we believe violates these Terms.',
                'disclaimers_title': 'Disclaimers',
                'disclaimers_desc': 'The service is provided "as is" without warranties of any kind. We do not guarantee that the service will be uninterrupted or error-free.',
                'governing_law_title': 'Governing Law',
                'governing_law_desc': 'These Terms shall be governed by and construed in accordance with the laws of the jurisdiction in which Chatme operates.',
                'footer_text': 'If you have any questions about these Terms, please contact us.'
            },
            'EXPLORE_PAGE': {
                'FILTERS': 'Filters',
                'RESET': 'Reset',
