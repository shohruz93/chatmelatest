    ...
    private translations: any = {
        'en': {
            ...
            'GAMES': {
                ...
                'ARROWS': 'Arrows',
                'ARROWS_DESC': 'Logic puzzle. Direct the arrows to clear the board.',
                'QUIZ': 'Vocabulary Quiz',
                'QUIZ_DESC': 'Test your vocabulary skills with multi-choice questions.',
                'ANAGRAM': 'Anagram',
                'ANAGRAM_DESC': 'Unscramble letters to find the correct word.',
                'PLAY_NOW': 'Play Now',
                'START': 'Start Game',
                'NEXT': 'Next Question',
                'RESULTS': 'See Results',
                ...
                'ANAGRAM_TITLE': 'Anagram Challenge',
            ...
            'ARROWS': {
                'TITLE': 'Arrows',
                'DESC': 'Swipe the arrows out of the board!',
                'LEVEL': 'Level',
                'PERFECT': 'Perfect!',
                'LEVEL_CLEARED': 'Level Cleared',
                'NEXT_LEVEL': 'Next Level',
                'GAME_OVER': 'Game Over',
                'GAME_OVER_MSG': 'You ran out of lives!',
                'RETRY': 'Retry'
            },
            'CHECKERS': {
                'VS_BOT': 'Play vs Bot',
                ...
                'NO_PLAYERS': 'No players online right now',
                'YOU': 'You',
                'TURN_WHITE': 'White\'s Turn',
                'TURN_BLACK': 'Black\'s Turn',
                'VICTORY': 'Victory!',
                'DEFEAT': 'Defeat',
                'WIN_MSG': 'You won the match! Well played.',
                'LOSS_MSG': 'The bot won this time. Keep practicing!',
                'ACCEPT': 'Accept',
                'REJECT': 'Reject',
                'LOBBY': 'Checkers Lobby',
                'BALANCE': 'Balance',
                'INVITED_YOU': 'invited you for',
                'WAITING_ACCEPT': 'Waiting for partner to accept',
                'YOUR_TURN': 'YOUR TURN',
        ...
        'ru': {
            ...
            'GAMES': {
                ...
                'ARROWS': 'Стрелки',
                'ARROWS_DESC': 'Логическая головоломка. Направляйте стрелки, чтобы очистить поле.',
                'QUIZ': 'Викторина слов',
                'QUIZ_DESC': 'Проверьте свой словарный запас с помощью тестов.',
                'ANAGRAM': 'Анаграмма',
                'ANAGRAM_DESC': 'Переставляйте буквы, чтобы найти правильное слово.',
                ...
                'QUIZ_TITLE': 'Викторина слов',
                'ANAGRAM_TITLE': 'Вызов Анаграмм',
            ...
            'CHECKERS': {
                ...
                'NO_PLAYERS': 'Сейчас нет игроков в сети',
                'YOU': 'Вы',
                'TURN_WHITE': 'Ход белых',
                'TURN_BLACK': 'Ход черных',
                'VICTORY': 'Победа!',
                'DEFEAT': 'Поражение',
                'WIN_MSG': 'Вы выиграли матч! Отличная игра.',
                'LOSS_MSG': 'Бот выиграл в этот раз. Продолжайте практиковаться!',
                'ACCEPT': 'Принять',
                'REJECT': 'Отклонить',
                'LOBBY': 'Лобби шашек',
                'BALANCE': 'Баланс',
                'INVITED_YOU': 'пригласил вас на',
                'WAITING_ACCEPT': 'Ожидание принятия партнером',
                'YOUR_TURN': 'ВАШ ХОД',
...
,
            ...
            'GAMES': {
                ...
                'ARROWS': 'Тирҳо',
                'ARROWS_DESC': 'Муаммои мантиқӣ. Тирҳоро барои тоза кардани майдон равона кунед.',
                'QUIZ': 'Викторинаи калимот',
                'QUIZ_DESC': 'Дониши калимоти худро бо тестҳо санҷед.',
                'ANAGRAM': 'Анаграмма',
                'ANAGRAM_DESC': 'Ҳарфҳоро барои ёфтани калимаи дуруст ҷобаҷо кунед.',
                'PLAY_NOW': 'Бозӣ кардан',
                'START': 'Оғози бозӣ',
                'NEXT': 'Саволи навбатӣ',
                'RESULTS': 'Натиҷаҳо',
                'PLAY_AGAIN': 'Бозии дубора',
                'EXIT': 'Баромад',
                'PERFECT': 'Натиҷаи олӣ!',
                'GOOD_JOB': 'Кори хуб!',
                'QUIZ_TITLE': 'Викторинаи калимот',
                'ANAGRAM_TITLE': 'Мусобиқаи Анаграмма',
                'INVITE_RECEIVED': 'мехоҳад бозӣ кунад барои',
                'INVITE_TITLE': 'Даъвати шашка!',
                'BET_AMOUNT': 'Миқдори шарт'
            },
            'ARROWS': {
                'TITLE': 'Тирҳо',
                'DESC': 'Тирҳоро аз майдон тоза кунед!',
                'LEVEL': 'Сатҳ',
                'PERFECT': 'Офарин!',
                'LEVEL_CLEARED': 'Сатҳ гузашта шуд',
                'NEXT_LEVEL': 'Сатҳи навбатӣ',
                'GAME_OVER': 'Бозӣ тамом',
                'GAME_OVER_MSG': 'Шумо дигар ҷон надоред!',
                'RETRY': 'Такрор'
            },
            'CHECKERS': {
                'VS_BOT': 'Бозӣ бо бот',
                'ONLINE': 'Бозии онлайн',
                'SELECT_DIFFICULTY': 'Сатҳи душвориро интихоб кунед',
                'BET_AMOUNT': 'Миқдори шарт',
                'ONLINE_PLAYERS': 'Бозингарон дар шабака',
                'NO_PLAYERS': 'Дар айни замон бозингарон дар шабака нестанд',
                'YOU': 'Шумо',
                'TURN_WHITE': 'Навбати сафедҳо',
                'TURN_BLACK': 'Навбати сиёҳҳо',
                'VICTORY': 'Ғалаба!',
                'DEFEAT': 'Мағлубият',
                'WIN_MSG': 'Шумо дар мусобиқа ғолиб шудед! Кори олӣ.',
                'LOSS_MSG': 'Бот ин дафъа ғолиб омад. Машқро идома диҳед!',
                'ACCEPT': 'Қабул',
                'REJECT': 'Рад кардан',
                'LOBBY': 'Лоббии шашка',
                'BALANCE': 'Баланс',
                'INVITED_YOU': 'шуморо даъват кард барои',
                'WAITING_ACCEPT': 'Интизории қабули шарик',
                'YOUR_TURN': 'НАВБАТИ ШУМО',
                'WAITING': 'Интизории шарик...',
                'TYPE_MESSAGE': 'Паём нависед...',
                'SEND': 'Фиристодан',
                'LEAVE': 'Тарки бозӣ',
                'LOSE': 'Шумо бохтед',
                'BOT_DESC': 'Бо боти ҳушманди мо бозӣ кунед ва тангаҳо ба даст оред!'
            },
            'COMMUNITY': {
